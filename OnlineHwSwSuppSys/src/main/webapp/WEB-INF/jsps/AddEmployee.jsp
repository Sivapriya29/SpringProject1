...
<h1>NEW EMPLOYEE</h1>
<br><br>
<form id="add" action="AddingEmployee" method="post">
</fieldset>

<label>Name:</label>
<input type="text" name="empName" id="name" style="width: 200px;" placeholder="Enter engineer name" required>
<br><br>
<label>Email:</label>
<input type="email" name="empEmail" id="name" style="width: 200px;" placeholder="Enter Email" required>
<br><br>
<label>Password:</label>
<input type="password" name="empPassword" id="name" style="width: 200px;" placeholder="Enter password" required>
<br><br>
<label>Mobile Number:</label>
<input type="tel" name="empMobNo" id="name" style="width: 200px;" placeholder="Enter Mobile number" required>
<br><br>
